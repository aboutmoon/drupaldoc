...
(function () {
    if (document.getElementsByClassName('page-node-type-manuals').length > 0) {
        ...
        window.onscroll = function() {
            ...
            var selectedLi = document.querySelectorAll('#pagetoc ul.pagetoc a.selected');
            ...
            for (var i = 0; i < h1s.length; i++) {
                if (h1s[i].offsetTop < pos) {
                    var selectA = document.querySelector('#pagetoc ul.pagetoc a[href="#' + h1s[i].id + '"]');
                    if (selectA) {
